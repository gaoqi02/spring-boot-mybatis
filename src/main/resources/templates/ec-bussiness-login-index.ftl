...
<head>
    ...
    button{border: none;}
    body{background: url(14.jpg) no-repeat center;height: 100%;width: 100%;}
    .signin-wrap{width: 350px;margin: 0 auto;padding-top: 200px;filter: alpha(opacity=0);  background-color: rgb(0, 0, 0);  background-color: rgba(0, 0, 0, 0);}
     ...
     .signin-section .username label{background:rgba(0,0,0,.12) url(/ec-web/static/images/signin/user.png) no-repeat 12px 10px}
     .signin-section .passwd label{background:rgba(0,0,0,.12) url(/ec-web/static/images/signin/pwd.png) no-repeat 10px 10px}
     ...
     .publicTips{width:315px;height: 24px;line-height: 24px;color: #c89949;border: 1px solid #ebdfa2;font-size: 12px;padding-left: 30px;margin-top: 5px;}
    </style>
</head>
<body>
            ...
            <div class="signin-section">
                ...
                <form class="entry" id="loginForm" name="loginForm" method="post" action="http://123.57.23.176:8080/ec-web/member-login.html">
                    ...
                    <div class="vcode">
                        <input type="text" placeholder="验证码" name="keyword" value="" maxlength="4" tabindex="3"> <img name="yzmImg" src="./登录-买线网官方商城_files/keyword.html"> <a href="http://123.57.23.176:8080/ec-web/login.html?backURL=/index.html#">换一张</a>
                    </div>

                    <div class="passwd-get">
                        <label style="font-size: 14px;"><input type="checkbox"> 自动登录</label>
                        <p class="get-forget">
                            <a href="http://123.57.23.176:8080/ec-web/show-forgetPassword.html" style="font-size: 14px;">忘记密码</a>
                        </p>
                    </div>
                    <div class="actions">
                    ...
                    <input type="hidden" id="backURL" name="backURL" value="/index.html">
                </form>
